...
export const brandStorySections: BrandStorySection[] = [
  {
    ...
    title: "從一顆水晶開始的相遇",
    body: [
      `${shopBrand.name} 的起點，來自一段需要被安放的日子。那時我們開始接觸天然水晶，發現它不像任何速效的解方，卻能在安靜配戴的日常裡，慢慢把心穩住。`,
      `我們相信，每個人都值得擁有一個屬於自己的錨點——不是用來依賴，而是提醒自己，任何時候都可以重新回到平靜。於是 ${shopBrand.name} 誕生，希望把這份安定感，交到更多人手上。`
    ],
    highlights: ["源自真實的自我安頓經驗", "從一條手鍊開始的分享", "陪伴超過 10,000 位顧客找到自己的頻率"],
    image: {
      src: "https://goodaytarot.com/images/about-crystal.jpg",
      alt: `${shopBrand.name} 品牌起源`
    }
  },
  {
    id: "belief",
    ...
    body: [
      `${shopBrand.name} 相信，每一顆水晶都帶著自己的頻率。它不修復你，它提醒你，你本來就是完整的。`,
